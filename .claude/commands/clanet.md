---
description: Network automation powered by Netmiko - connect, backup, and health-check network devices
argument-hint: <device-name>
allowed-tools: [Read, Bash, Glob, Grep]
---

# clanet - Network Automation
...
- `/clanet:check` - Run health check (interfaces, BGP, OSPF)
